	...
	if(GLOB.ratvar_awakens)
		...
		for(var/mob/living/L in GLOB.alive_mob_list)
			if(is_servant_of_ratvar(L))
				servants++
		var/datum/antagonist/clockcult/C = has_antag_datum(/datum/antagonist/clockcult) //var/datum/antagonist/clockcult/C = has_antag_datum(/datum/antagonist/clockcult,TRUE)
		if(C && C.clock_team)
